...
@section('title', 'Masterdata Jurusan')
@section('content')
<div class="container">
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Masterdata Jurusan</h3>
        ...
        <form id="form-data" name="scopeForm" enctype="multipart/form-data" method="POST" action="" class="form-horizontal">
            <div class="modal-body">
                ...
                <div class="form-group">
                    <label class="col control-label">Nama Jurusan :</label>
...
<script>
    ...
    $(document).ready(function () {
        table = $('#table').DataTable({
            ...
            ajax: {
                type: 'POST',
                url: '{{ route("masterdata.jurusan.json") }}',
                data: {
                    _token: "{{ csrf_token() }}",
                    search: function(){
...
<script>
    function tambahData(id){
        $('#form-data').attr('action', "{{ url('masterdata/jurusan/store') }}");
        $('#nama_jurusan').val("");
 ...
 <script>
    function editData(id){
        $.get("{{url('masterdata/jurusan/detail')}}" + "/" +id, function(data){
            $('#form-data').attr('action', "{{ url('masterdata/jurusan/update') }}"+"/"+id);
    ...
    function destroyData(id){
        ...
        confirmButtonText: 'Yes, delete it!'
            ...
            if (result.isConfirmed) { 
                $.ajax({
                    type    : 'DELETE',
                    url     : "{{url('masterdata/jurusan/delete')}}" +"/"+id,
