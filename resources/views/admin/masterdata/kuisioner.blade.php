...
@section('title', 'Masterdata Kuisioner')
@section('content')
<div class="container">
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Masterdata Kuisioner</h3>
    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="formModalLabel">Form Kuisioner</h5>
        ...
        <form id="form-data" name="scopeForm" enctype="multipart/form-data" method="POST" action="" class="form-horizontal">
            <div class="modal-body">
                ...
                <div class="form-group">
                    <label class="col control-label">Kuisioner :</label>
                    <div class="col-sm-12 mt-2">
                        <input type="text" name="kuisioner" id="kuisioner" class="form-control" required>
                    </div>
                </div>
...
<script>
    ...
    $(document).ready(function () {
        table = $('#table').DataTable({
            ...
            ajax: {
                type: 'POST',
                url: '{{ route("masterdata.kuisioner.json") }}',
                data: {
                    _token: "{{ csrf_token() }}",
                    search: function(){
...
<script>
    function tambahData(id){
        $('#form-data').attr('action', "{{ url('masterdata/kuisioner/store') }}");
        $('#kuisioner').val("");
        $('#keterangan').val("");
 ...
 <script>
    function editData(id){
        $.get("{{url('masterdata/kuisioner/detail')}}" + "/" +id, function(data){
            $('#form-data').attr('action', "{{ url('masterdata/kuisioner/update') }}"+"/"+id);
            $('#kuisioner').val(data.kuisioner);
    ...
    function destroyData(id){
        ...
        confirmButtonText: 'Yes, delete it!'
            ...
            if (result.isConfirmed) { 
                $.ajax({
                    type    : 'DELETE',
                    url     : "{{url('masterdata/kuisioner/delete')}}" +"/"+id,
